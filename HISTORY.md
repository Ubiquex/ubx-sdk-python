...
Go sibling (`ubx-sdk-go`) — the same real risk applies here. Verify the
actual published PyPI package directly before trusting any "published" claim
about this repo; see `CLAUDE.md`.
